/*
    Generated date:     2020-09-25T12:56:29Z
...
IF @baselineRequired = 1
  BEGIN
    PRINT '----- baselined: Migrations\1.0.0-Baseline\001_20200924-1943_Redgate.sql (marked as deployed) -----';
    ...
    VALUES                                         (CAST ('01b55767-e3e3-4c40-b867-d676ffca7728' AS UNIQUEIDENTIFIER), 'DBD85E42FA956A6649B35CF22BB6E88265DCAADCCCDEDE0B92BBC3429B80BC24', 'Migrations\1.0.0-Baseline\001_20200924-1943_Redgate.sql', SYSDATETIME(), SYSTEM_USER, 0, NULL, '$(PackageVersion)', CASE '$(ReleaseVersion)' WHEN '' THEN NULL ELSE '$(ReleaseVersion)' END);
  END
...
***** EXECUTING MIGRATION "Migrations\1.0.0-Baseline\001_20200924-1943_Redgate.sql", ID: {01b55767-e3e3-4c40-b867-d676ffca7728} *****';

GO
IF EXISTS (SELECT 1 FROM [$(DatabaseName)].[dbo].[__MigrationLogCurrent] WHERE [migration_id] = CAST ('01b55767-e3e3-4c40-b867-d676ffca7728' AS UNIQUEIDENTIFIER))
BEGIN
  PRINT '----- Skipping "Migrations\1.0.0-Baseline\001_20200924-1943_Redgate.sql", ID: {01b55767-e3e3-4c40-b867-d676ffca7728} as it has already been run on this database';
  SET NOEXEC ON;
END
...
GO
IF NOT EXISTS (SELECT 1 FROM [$(DatabaseName)].[dbo].[__MigrationLogCurrent] WHERE [migration_id] = CAST ('01b55767-e3e3-4c40-b867-d676ffca7728' AS UNIQUEIDENTIFIER))
  PRINT '***** FINISHED EXECUTING MIGRATION "Migrations\1.0.0-Baseline\001_20200924-1943_Redgate.sql", ID: {01b55767-e3e3-4c40-b867-d676ffca7728} *****
';
...
GO
IF NOT EXISTS (SELECT 1 FROM [$(DatabaseName)].[dbo].[__MigrationLogCurrent] WHERE [migration_id] = CAST ('aab5f5fe-6c5f-5b1c-bd80-5046da2cb829' AS UNIQUEIDENTIFIER) AND [script_checksum] = '0336556AD6C972F496408E918F0A8B43D92839A6F98D10359F86BF980E9F69FA')
  PRINT '

***** EXECUTING MIGRATION "Programmable Objects\dbo\Views\newview.sql", ID: {aab5f5fe-6c5f-5b1c-bd80-5046da2cb829} *****';

GO
IF EXISTS (SELECT 1 FROM [$(DatabaseName)].[dbo].[__MigrationLogCurrent] WHERE [migration_id] = CAST ('aab5f5fe-6c5f-5b1c-bd80-5046da2cb829' AS UNIQUEIDENTIFIER) AND [script_checksum] = '0336556AD6C972F496408E918F0A8B43D92839A6F98D10359F86BF980E9F69FA')
BEGIN
...
GO
EXECUTE ('CREATE VIEW [dbo].[newview]
...
IF NOT EXISTS (SELECT 1 FROM [$(DatabaseName)].[dbo].[__MigrationLogCurrent] WHERE [migration_id] = CAST ('aab5f5fe-6c5f-5b1c-bd80-5046da2cb829' AS UNIQUEIDENTIFIER) AND [script_checksum] = '0336556AD6C972F496408E918F0A8B43D92839A6F98D10359F86BF980E9F69FA')
  INSERT [$(DatabaseName)].[dbo].[__MigrationLog] ([migration_id], [script_checksum], [script_filename], [complete_dt], [applied_by], [deployed], [version], [package_version], [release_version])
  VALUES                                         (CAST ('aab5f5fe-6c5f-5b1c-bd80-5046da2cb829' AS UNIQUEIDENTIFIER), '0336556AD6C972F496408E918F0A8B43D92839A6F98D10359F86BF980E9F69FA', 'Programmable Objects\dbo\Views\newview.sql', SYSDATETIME(), SYSTEM_USER, 1, NULL, '$(PackageVersion)', CASE '$(ReleaseVersion)' WHEN '' THEN NULL ELSE '$(ReleaseVersion)' END);
